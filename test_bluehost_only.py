...
def test_bluehost_connection():
    """Test connection to Bluehost MySQL only"""
    
    print("=== Testing Bluehost MySQL Connection ===")
    print("IP to whitelist: 142.115.175.25")
    print("=" * 50)
...
if __name__ == "__main__":
    success = test_bluehost_connection()
    
    if success:
        print("\nNext steps:")
        print("1. Update your MQTT subscriber to use Bluehost MySQL")
        print("2. Remove SQLite fallback from database.py")
        print("3. Start collecting sensor data in Bluehost!")
    else:
        print("\nPlease fix the connection issue first!")
        print("Check BLUEHOST_IP_WHITELIST_GUIDE.md for detailed instructions.")
