...
<body>
    <div class="container">
        ...
        <div class="controls">
            ...
            <button class="btn" onclick="testDatabase()">🗄️ Test Database</button>
    ...
    <script>
        ...
        function updateSensorCard(data) {
            console.log('updateSensorCard called with:', data);
            ...
            if (!sensorCard) {
                console.log('Creating new sensor card for:', deviceId);
        ...
        function updateSensorCardContent(card, data) {
            console.log('updateSensorCardContent called with:', data);
            ...
            `;
            console.log('Card updated with HTML:', card.innerHTML);
        }
        ...
        function initializeCharts() {
            ...
            charts.temperature = new Chart(tempCtx, Object.assign({}, chartConfig, {
                data: {
                    labels: [],
                    datasets: [{
                        label: 'Temperature C',
            ...
            charts.humidity = new Chart(humCtx, Object.assign({}, chartConfig, {
                data: {
                    labels: [],
                    datasets: [{
            ...
            charts.co2 = new Chart(co2Ctx, Object.assign({}, chartConfig, {
                data: {
                    labels: [],
                    datasets: [{
                        label: 'CO2 ppm',
        ...
        function displayHistoryData(records) {
            ...
            if (records.length === 0) {
                historyDiv.innerHTML = '<div class="no-data">No records found</div>';
                return;
            }
            ...
            records.forEach(record => {
                ...
                html += `
                    <div class="sensor-card">
                        ...
                        <div class="room-info">
                            <div><strong>Device ID:</strong> ${record.device_id}</div>
                            <div><strong>Record Time:</strong> ${new Date(record.timestamp).toLocaleString('en-US')}</div>
                        </div>
                    </div>
                `;
            });
