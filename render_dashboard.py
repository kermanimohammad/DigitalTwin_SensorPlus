...
# -*- coding: utf-8 -*-
"""
Render.com Compatible Dashboard
Local version adapted for Render.com deployment
"""
...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.getenv('SECRET_KEY', 'render_sensor_secret_key')
...
class RenderMQTTSimulator:
    """MQTT Simulator for Render.com deployment"""
    ...
    def publish_sensor_data(self, data):
        ...
        print(f"[Render Simulator] Published: {device_id} = {value} {unit}")
    
    def run(self):
        """Run the simulator"""
        self.running = True
        print(f"[Render Simulator] Started publishing sensor data every {self.interval} seconds")
...
<body>
    <div class="container">
        <div class="header">
            <h1>DigitalTwin Sensor Dashboard <span class="render-badge">RENDER</span></h1>
...
def handle_connect():
    ...
    emit('status', {'message': 'Connected to Render dashboard'})
...
def start_simulator():
    ...
    print("[Render System] Simulator started")

if __name__ == '__main__':
    print("=" * 60)
    print("🚀 Starting Render.com Compatible Dashboard")
    print("=" * 60)
