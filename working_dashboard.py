...
# -*- coding: utf-8 -*-
"""
Working Dashboard with Database Storage
- Saves data to database
- Shows real-time data in dashboard
...
class WorkingMQTTSubscriber:
    ...
    def start(self):
        try:
            ...
            print("🚀 Working MQTT Subscriber started")
        except Exception as e:
            print(f"❌ Failed to start MQTT subscriber: {e}")

# Initialize MQTT subscriber
mqtt_subscriber = WorkingMQTTSubscriber()
...
<head>
    ...
    <title>داشبورد کارکرد - Working Dashboard</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🌡️ داشبورد کارکرد</h1>
            <p>Real-time + Database Storage</p>
        </div>
        ...
        <div class="controls">
            ...
            <button class="btn" onclick="loadHistory()">📚 تاریخچه</button>
...
def api_history():
    """API endpoint to get historical data from database"""
    try:
...
if __name__ == '__main__':
    print("🚀 Starting Working Sensor Dashboard...")
